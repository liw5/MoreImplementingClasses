...
class Line(object):
    ...
    def length(self):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        length = math.sqrt((self.start.x-self.end.x)**2+(
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        new_line = Line(Point(self.start.x+other_line.start.x,
                              self.start.y+other_line.start.y),
                        Point(self.end.x+other_line.end.x,
