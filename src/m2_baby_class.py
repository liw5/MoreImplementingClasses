...
class Baby(object):
    def __init__(self,str):
        self.name = str
        self.hour_passed = 0
        print('{} {}'.format('Hello baby', self.name))

    def feed_baby(self):
        print('{} {}'.format('Thank you for feeding baby', self.name))

    def hour_passes(self):
        self.hour_passed = self.hour_passed + 1
        if self.hour_passed == 1:
            print( '{} {} {}'.format('Baby', self.name,'is sleeping.'))
        if self.hour_passed == 2:
            print( '{} {} {}'.format('Baby', self.name, 'is awake. '
                                                         'Time for food'))
        if self.hour_passed >= 3:
            print( '{} {} {}'.format('Baby', self.name, 'is CRYING '
                                                         'uncontrollably!  '
                                                         'Feed the Baby!'))
