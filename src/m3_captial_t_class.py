...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        self.h_rect = rg.Rectangle(rg.Point(intersection_center.x - width / 2,
                                   ...
                                   rg.Point(intersection_center.x + width / 2,
                                            intersection_center.y -
                                            letter_thickness / 2))
        self.v_rect = rg.Rectangle(rg.Point(
    ...
    def clone(self):
        ...
        new = CapitalT(self.intersection_center,self.width,self.height,
                        self.letter_thickness)
        new.set_colors(self.fi_color,self.out_color)
        return new
